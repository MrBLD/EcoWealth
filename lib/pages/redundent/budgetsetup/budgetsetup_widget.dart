...
import 'budgetsetup_model.dart';
export 'budgetsetup_model.dart';
...
class _BudgetsetupWidgetState extends State<BudgetsetupWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BudgetsetupModel());
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Customize your spending limits',
                          style:
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FlutterFlowChoiceChips(
                            options: [ChipData('Weekly'), ChipData('Monthly')],
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Slider(
                              ...
                              min: 0.0,
                              max: 2000.0,
                              value: _model.sliderValue1 ??= 1200.0,
                              onChanged: (newValue) {
                                newValue =
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Slider(
                              ...
                              min: 0.0,
                              max: 1000.0,
                              value: _model.sliderValue2 ??= 600.0,
                              onChanged: (newValue) {
                                newValue =
                                    double.parse(newValue.toStringAsFixed(4));
                                safeSetState(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Slider(
                              ...
                              min: 0.0,
                              max: 500.0,
                              value: _model.sliderValue3 ??= 300.0,
                              onChanged: (newValue) {
                                newValue =
                                    double.parse(newValue.toStringAsFixed(4));
                                safeSetState(
