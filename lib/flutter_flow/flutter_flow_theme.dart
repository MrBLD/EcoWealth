...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF0099FF);
  late Color tertiary = const Color(0xFF3F51B5);
  late Color alternate = const Color(0xFFFFEB3B);
  ...
  late Color accent3 = const Color(0xFFB6E3FF);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF007EFF);
  late Color tertiary = const Color(0xFF303F9F);
  late Color alternate = const Color(0xFFFBC02D);
  ...
  late Color accent2 = const Color(0xFFC2185B);
  late Color accent3 = const Color(0xFF144C6C);
